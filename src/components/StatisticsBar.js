...
class StatisticsBar extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Segment className='Stats' inverted>
          <Statistic.Group size={'tiny'} inverted >
            ...
            <Statistic className='Stat' inverted label='Chris Hayward' value={<a href='https://github.com/KingofGondor12' target='_blank'><Icon name='rocket' size='big' /></a>} />
          </Statistic.Group>
        </Segment>
      </div>
    )
